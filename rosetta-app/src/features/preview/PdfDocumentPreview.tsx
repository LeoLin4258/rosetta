...
export function PdfDocumentPreview({
  ...
  // Auto-generate the translated PDF the first time translation reaches 100%
  // for this job. After that, the user can press "重新生成" to rerun.
  ...
  const translationPlaceholder = (() => {
    ...
    if (segmentCount === 0) return "尚无翻译数据。";
